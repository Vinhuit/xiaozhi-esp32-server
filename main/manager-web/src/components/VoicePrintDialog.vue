    ...
    <div class="dialog-container">
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="110px" label-position="left" class="param-form">
        <el-form-item label="Voice Vector" prop="audioId" class="form-item">
          <el-select v-model="form.audioId" placeholder="Please select a language message" class="custom-select">
        ...
        <el-form-item label="Name" prop="sourceName" class="form-item">
          <el-input v-model="form.sourceName" placeholder="Please enter the name" class="custom-input"></el-input>
        </el-form-item>

        <el-form-item label="Description" prop="introduce" class="form-item remark-item">
          <el-input type="textarea" v-model="form.introduce" placeholder="Please enter a description" :rows="3" class="custom-textarea"
...
export default {
  ...
  methods: {
    ...
    playAudio(audioId) {
      if (this.playingAudioId === audioId) {
        // Stop if the current audio is playing
        ...
        if (valid) {
          ...
          this.$emit('submit', {
            form: this.form,
              ...
              this.saving = false; // Finish loading
            }
          });
